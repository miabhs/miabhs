 ...
 */
@Embeddable
public class AktifitasId implements Serializable {
    ...
    public AktifitasId(AktifitasHarianId aktifitasHarian, String bentukAktifitas) {
        this.aktifitasHarian = aktifitasHarian;
        this.bentukAktifitas = bentukAktifitas;
    }

    public AktifitasId(String... params) {
    ...
    public boolean equals(Object obj) {
        ...
        final AktifitasId other = (AktifitasId) obj;
