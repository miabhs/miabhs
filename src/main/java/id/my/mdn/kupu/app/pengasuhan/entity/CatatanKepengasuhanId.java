 ...
 */
@Embeddable
public class CatatanKepengasuhanId implements Serializable {
    ...
    public CatatanKepengasuhanId() {
    }

    public CatatanKepengasuhanId(Long santri, Long periodePembelajaran) {
        this.santri = santri;
        this.periodePembelajaran = periodePembelajaran;
    }    

    public CatatanKepengasuhanId(String... attributes) {
    ...
    public boolean equals(Object obj) {
        ...
        final CatatanKepengasuhanId other = (CatatanKepengasuhanId) obj;
