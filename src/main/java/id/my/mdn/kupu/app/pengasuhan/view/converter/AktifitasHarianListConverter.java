 ...
 */
@Singleton @FacesConverter(value = "AktifitasHarianListConverter", managed = true)
public class AktifitasHarianListConverter extends SelectionsConverter<AktifitasHarian> {
