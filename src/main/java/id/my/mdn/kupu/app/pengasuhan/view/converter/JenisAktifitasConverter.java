 ...
 */
@Singleton
@FacesConverter(managed = true, value = "JenisAktifitasConverter")
public class JenisAktifitasConverter implements Converter<JenisAktifitas> {

    @Override
    public JenisAktifitas getAsObject(FacesContext context, UIComponent component, String value) {
        return KEnum.valueOf(JenisAktifitas.class, value);
    }
