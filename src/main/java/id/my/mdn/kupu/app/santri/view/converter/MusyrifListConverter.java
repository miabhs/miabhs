 ...
 */
@Singleton @FacesConverter(value = "MusyrifListConverter", managed = true)
public class MusyrifListConverter extends SelectionsConverter<Musyrif> {
    
    @Inject
    private MusyrifFacade dao;

    @Override
    public Musyrif getAsObject(String value) {
        return dao.find(KLong.valueOf(value));
    }

    @Override
    public String getAsString(Musyrif value) {
