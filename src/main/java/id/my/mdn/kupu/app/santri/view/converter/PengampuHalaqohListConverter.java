...
public class PengampuHalaqohListConverter extends SelectionsConverter<PengampuHalaqoh> {
    
    @Inject
    private PengampuHalaqohFacade dao;

    @Override
    public PengampuHalaqoh getAsObject(String value) {
        return dao.find(new PartyRelationshipId(EntityUtil.parseCompositeId(value)));
    }

    @Override
    public String getAsString(PengampuHalaqoh value) {
