...
import id.my.mdn.kupu.core.party.view.form.TelecommunicationNumberForm;
 ...
 * @author aphasan
 */
@Named(value = "telecommunicationNumberEditorPage")
@ViewScoped
public class TelecommunicationNumberEditorPage extends FormPage<PartyContactMechanism> {

    @Inject
    private PartyContactMechanismFacade dao;

    @Inject @Form
    private TelecommunicationNumberForm form;
    ...
    public TelecommunicationNumberForm getForm() {
        return form;
    }
